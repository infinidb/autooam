...
# the original recipe always do this but we are guaranteed that our
# autooam base boxes have sufficient software on them and don't want
# to rely on any package operations during the tests 
# package 'sudo' do
#   action :install
# end
